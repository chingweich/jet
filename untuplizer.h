      ...
      // elementary data types; fixed/variable length arrays of elementary types
         ...
         if (leaf->IsA() == TLeafF::Class())
            ...
            descr = "Bool_t";
			 ...
			 cout<<Form("unsupported leaf of class %s", leaf->ClassName())<<endl;
